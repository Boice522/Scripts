const $ = new Env('互助码')
$.zdUrl = 'http://api.turinglabs.net/api/v1/jd/bean/create/tqfyrzzrijijwowptsjzerghjwpjapqlm4voota/'
$.ncUrl = 'http://api.turinglabs.net/api/v1/jd/farm/create/33ac621a4e6c4e3c9c33ace1c241381d/'
$.mcUrl = 'http://api.turinglabs.net/api/v1/jd/pet/create/MTAxODc2NTEzMzAwMDAwMDAyNzU0ODE0OQ==/'
$.result = []
